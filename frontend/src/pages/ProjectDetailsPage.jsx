...
import { fetchProjectById } from "../features/projects/projectThunks";
...
const ProjectDetailsPage = () => {
  ...
  const { loading, selectedProject } = useSelector((state) => state.projects);
      ...
      <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
        <div className="xl:col-span-2 space-y-8">
          ...
          <div className="rounded-3xl bg-white p-8 shadow-sm">
            ...
            <AssignedUsers users={selectedProject.assignedUsers} />
          </div>
          ...
          <div className="rounded-3xl bg-white p-8 shadow-sm">
            ...
            <AttachmentList attachments={selectedProject.attachments} />
          </div>
        </div>
