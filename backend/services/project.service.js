...
export const createProjectService = async (payload) => {
  ...
  if (!assignedUsers || assignedUsers.length === 0) {
    throw new ApiError(400, "Please assign at least one user.");
  }
...
export const updateStatusService = async (projectId, userId, status) => {
  ...
  const assigned = project.assignedUsers.some(
